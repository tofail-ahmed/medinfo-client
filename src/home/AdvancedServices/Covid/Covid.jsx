...
const logo=data?.data[6].imgUrl
  ...
  const handleSubmit = (e) => {
    ...
    try {
      ...
      alert(
        "An error occurred while saving your data. Please ensure your browser allows localStorage."
      );
    }
  };
    ...
    <div className="mt-20">
      ...
      <div className=" bg-slate-100  my-12 rounded-t-md flex justify-around items-center w-[60%]  mx-auto lg:h-[120px] h-[100px]">
        ...
        <h1 className=" text-slate-900 lg:text-lg text-xs font-bold w-[60%]">
          Get your flu shot or any vaccine and get a coupon for 20% off your
          next purchase of $20 or more up to $100 as a myWalgreens member2
        </h1>
      </div>
